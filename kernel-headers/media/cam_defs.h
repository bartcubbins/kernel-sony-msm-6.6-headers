...
struct cam_ubwc_config {
  ...
  union {
    ...
    struct {
      struct {
      } __empty_ubwc_plane_cfg_array_flex;
      struct cam_ubwc_plane_cfg_v1 ubwc_plane_cfg_array_flex[][CAM_PACKET_MAX_PLANES - 1];
    };
  };
};
struct cam_ubwc_config_v2 {
  ...
  union {
    ...
    struct {
      ...
      struct cam_ubwc_plane_cfg_v2 ubwc_plane_cfg_array_flex[][CAM_PACKET_MAX_PLANES - 1];
    };
  };
};
struct cam_ubwc_config_v3 {
  ...
  union {
    ...
    struct {
      ...
      struct cam_ubwc_plane_cfg_v3 ubwc_plane_cfg_array_flex[][CAM_PACKET_MAX_PLANES - 1];
    };
  };
};
